...
/*	TIM_TimeBaseStructure8.TIM_Period = 4096; 
  TIM_TimeBaseStructure8.TIM_Prescaler = 3 ;
  TIM_TimeBaseStructure8.TIM_ClockDivision = 0;
  TIM_TimeBaseStructure8.TIM_CounterMode = TIM_CounterMode_CenterAligned2;
  ...
  TIM_OCInitStructure8.TIM_OCPolarity = TIM_OCNPolarity_High;
  ...
  TIM_BDTRInitStructure8.TIM_AutomaticOutput = TIM_AutomaticOutput_Enable;
