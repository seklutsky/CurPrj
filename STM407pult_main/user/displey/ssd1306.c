...
#define Reset_Pin       GPIO_Pin_10
  ...
  #define I2C_clock     200000  // Частота работы I2C        
  ...
  #define SPI_periph    SPI2    // SPI1 или SPI2        
  #define CSPinUsed     1       // Используется управление пином CS ssd1306      
